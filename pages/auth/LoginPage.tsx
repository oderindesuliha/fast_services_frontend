...
setError('');
    ...
    try {
      // Call the login and receive the mapped role back so we can redirect immediately
      const returnedRole = await login(email, password);

      // Redirect based on returned role from login (fall back to context role)
      const roleToUse = returnedRole || role;
      ...
      switch (roleToUse) {
        case 'SUPER_ADMIN':
          ...
          break;
        case 'ORG_ADMIN':
          navigate('/organization/offerings', { replace: true });
          break;
        case 'STAFF':
          navigate('/staff/queue', { replace: true });
          break;
        case 'CUSTOMER':
          navigate('/customer/upcoming', { replace: true });
          break;
        default:
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500text-gray-900 rounded-t-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
